...
const KNOWN_GLOBALS = [
  'TOOLS', 'TOOL_GROUPS', 'FLOATBAR_GROUPS', 'BUILDING_TOOLS', 'PLANTA_SHAPES', 'DOOR_TYPES', 'WINDOW_TYPES', 'ROOF_TYPES', 'FACADE_TYPES',
  'BALCONY_TYPES', 'LIGHT_TYPES', 'LIGHT_SPORTS', 'WALL_VIEWS', 'FORGE_TYPES', 'FENCE_VIEWS', 'GATE_TYPES', 'GATE_VIEWS',
  'STAIR_TYPES', 'STAIR_VIEWS', 'SYMBOL_TYPES', 'COLUMN_TYPES', 'FURNITURE_TYPES',
  'PORCH_TYPES', 'SILHOUETTE_TYPES', 'ROOF_ADDONS',
  'FORM_VARIANTS', 'TABLE_VARIANTS', 'CHART_VARIANTS',
  'BUTTON_VARIANTS', 'INPUT_VARIANTS', 'CARD_VARIANTS', 'NAV_VARIANTS',
  'DIALOG_VARIANTS', 'UI_PIECE_VARIANTS', 'UI_PIECE_DEFAULTS', 'FRAME_PRESETS',
  'TOOLTIP_SHAPES', 'TOOLTIP_TAILS',
  ...
  'COLORS', 'CANVAS_PRESETS', 'CANVAS_W', 'CANVAS_H',
