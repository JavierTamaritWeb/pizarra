...
test('index publica v3.7.1 sin caché antigua y documenta el tamaño del borrador', () => {
  const html = fs.readFileSync(path.resolve(__dirname, '..', 'index.html'), 'utf8');
  assert.match(html, /class="topbar__badge">v3\.7\.1</);
  assert.match(html, /css\/styles\.css\?v=3\.7\.1/);
  assert.match(html, /src\/js\/app\.js\?v=3\.7\.1/);
  assert.match(html, /src\/js\/building\.js\?v=3\.7\.1/);
  assert.match(html, /src\/js\/garden\.js\?v=3\.7\.1/);
  assert.match(html, /src\/js\/config\.js\?v=3\.7\.1/);
  ...
  assert.match(html, /src\/js\/solid\.js\?v=3\.7\.1/);
  assert.match(html, /src\/js\/airbrush\.js\?v=3\.7\.1/);
