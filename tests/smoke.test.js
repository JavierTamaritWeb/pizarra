...
test('index publica v1.22.0 sin caché antigua y documenta el tamaño del borrador', () => {
  const html = fs.readFileSync(path.resolve(__dirname, '..', 'index.html'), 'utf8');
  assert.match(html, /class="topbar__badge">v1\.22\.0</);
  assert.match(html, /css\/styles\.css\?v=1\.22\.0/);
  assert.match(html, /js\/app\.js\?v=1\.22\.0/);
  assert.match(html, /js\/building\.js\?v=1\.22\.0/);
  assert.match(html, /js\/garden\.js\?v=1\.22\.0/);
  assert.match(html, /js\/config\.js\?v=1\.22\.0/);
