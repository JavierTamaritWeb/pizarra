...
![Versión](https://img.shields.io/badge/versi%C3%B3n-1.14.0-blueviolet)
...
![Tests](https://img.shields.io/badge/tests-273%20%E2%9C%93-brightgreen)
...
- 🧽 **Borrador real y regulable** (`E`): **elimina de verdad** los elementos que
  ...
  acción. Los proyectos creados antes de la v1.14.0 conservan sus máscaras
