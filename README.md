...
| **Puntas de flecha** | Clásica, **maciza**, **barra** —el remate de cota de un plano—, **punto** o **media** —un ala sola, el rasgo de un 1 escrito a mano—, en los dos extremos cuando la flecha es de doble punta. |
...
1. Elige una herramienta en la barra lateral —**Mover** abre la lista, arriba del todo— o con su atajo de teclado. Si prefieres tenerlas a mano sobre el lienzo, el botón **Barras** del topbar desglosa la barra en **cinco paletas flotantes** arrastrables y plegables (al recargar vuelven a su sitio de fábrica).
