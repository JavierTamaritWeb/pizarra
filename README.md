...
| **Texto en varias filas** | En el editor de texto, `Enter` hace un salto de línea, como en Word, y `Ctrl`/`Cmd`+`Enter` o un clic fuera confirma (v3.30.0); el editor crece con lo escrito y no envuelve, así que se ve tal como se va a pintar. En los rótulos de una línea (botón, input, flecha…) `Enter` confirma. |
