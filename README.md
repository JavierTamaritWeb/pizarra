...
[![Versión](https://img.shields.io/badge/versión-3.17.0-blueviolet?style=flat-square)](CHANGELOG.md)
...
[![Tests](https://img.shields.io/badge/tests-942%20unitarios%20%2B%20187%20e2e-brightgreen?style=flat-square)](#tests)
...
- **Pestañas de pizarra** (v3.17.0): varias pizarras abiertas a la vez, cada una con su dibujo, su historial de deshacer, su zoom y su aspecto de lienzo. Se crean con «+», se renombran con doble clic y se cierran con «×» (preguntando si tienen dibujo); al reabrir la app **vuelven todas**, con la activa recordada. «Abrir proyecto» abre el `.json` en su propia pestaña, con su nombre.
...
**942 tests unitarios** con el runner nativo de Node, sin ninguna dependencia
de runtime:
