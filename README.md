...
[![Tests](https://img.shields.io/badge/tests-983%20unitarios%20%2B%20201%20e2e-brightgreen?style=flat-square)](#tests)
...
| `T` `J` `B` `I` `M` `N` `K` | Texto · Emoji · Botón · Input · Imagen · Navbar · Tarjeta (Marco, Formulario, Tabla, Gráfico, Diálogo, Pestañas y Menú lateral van sin atajo) |
...
Las herramientas que abren catálogo (Edificios y Jardín) muestran su modal de tipos al pulsar el atajo. **Aerógrafo**, **Tinta**, **Flecha semicírculo**, **Select**, **Marco**, las seis piezas de formulario y datos, **Balcón**, **Muro**, **Verjas**, **Cancela**, **Iluminación**, las siete de la parte técnica del plano, **Caminos**, **Aromáticas**, **Trepadoras** y las cuatro de 3D no tienen atajo: ya no queda ninguna tecla suelta libre.
...
**983 tests unitarios** con el runner nativo de Node, sin ninguna dependencia
de runtime:
...
**201 tests end-to-end** en un navegador real (Playwright), para lo que un stub no puede juzgar: layout, CSS, foco, acciones por defecto del navegador, la navegación del lienzo (zoom al cursor, pan, encuadres), el feedback en vivo, los gestos multitáctiles (despachados por CDP), los flujos completos de Verjas y Cancela y el Jardín botánico en escritorio, móvil y anchos intermedios.
