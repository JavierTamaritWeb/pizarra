...
[![Versión](https://img.shields.io/badge/versión-2.17.0-blueviolet?style=flat-square)](CHANGELOG.md)
...
[![Tests](https://img.shields.io/badge/tests-561%20unitarios%20%2B%2055%20e2e-brightgreen?style=flat-square)](#tests)
...
**561 tests unitarios** con el runner nativo de Node, sin ninguna dependencia
de runtime:
