...
[![Versión](https://img.shields.io/badge/versión-2.16.3-blueviolet?style=flat-square)](CHANGELOG.md)
...
[![Tests](https://img.shields.io/badge/tests-558%20unitarios%20%2B%2053%20e2e-brightgreen?style=flat-square)](#tests)
...
**558 tests unitarios** con el runner nativo de Node, sin ninguna dependencia
de runtime:
...
**53 tests end-to-end** en un navegador real (Playwright), para lo que un stub no puede juzgar: layout, CSS, foco, acciones por defecto del navegador, los flujos completos de Verjas y Cancela y el Jardín botánico en escritorio, móvil y anchos intermedios.
